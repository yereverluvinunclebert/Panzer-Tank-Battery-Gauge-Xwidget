/*
	...
	Face adapted from KJC66's original idea
...
function menuitem4OnClick(Sender)
{
          ...
          {
              OpenURL("http://lightquick.co.uk/instructions-for-the-panzer-battery-gauge-xwidget.html?Itemid=264");
          }
}
//=====================
//End function
...
function menuitem12OnClick(Sender)
{
          ...
          {
              openURL("http://lightquick.co.uk/downloads/panzer-battery-gauge-xwidget.html?Itemid=264");
          }
}
//=====================
//End function
...
function pinOnMouseUp(Sender,Button,Shift,X,Y)
{
